...
class DuitkuService implements PaymentGatewayInterface
{
    ...
    public function createTransaction(array $params): array
    {
        try {
            ...
            return ['success' => false, 'message' => $data['message'] ?? 'Transaksi gagal', 'data' => $data];
        } catch (\Throwable $e) {
    ...
    public function getTransactionDetail(string $reference): array
    {
        try {
            ...
            $response = Http::post($this->baseUrl . '/merchant/transactionDetail', $params);
            $data     = $response->json();
