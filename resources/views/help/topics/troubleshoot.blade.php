...
# Debug mode (hentikan service dulu)
systemctl stop freeradius
freeradius -X</code></pre>
        <div class="alert alert-warning mt-2"><i class="fas fa-exclamation-triangle mr-1"></i>Mode debug (<code>freeradius -X</code>) akan menampilkan detail error konfigurasi. Cari baris <code>ERROR</code> atau <code>FAILED</code>.</div>
