            ...
            <table class="table table-sm table-bordered">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>Ringkasan operasional tenant: pelanggan, session, tagihan, performa singkat.</td>
                    ...
                    <tr>
                        ...
                        <td>Kelola tenant, paket langganan global, laporan pendapatan platform.</td>
                        <td>Governance multi-tenant berjalan konsisten.</td>
                    </tr>
                </tbody>
            </table>
        </div>
