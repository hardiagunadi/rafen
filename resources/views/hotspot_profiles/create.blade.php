...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <h4 class="mb-0">Tambah Profil Hotspot</h4>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="number" step="0.01" name="harga_jual" value="{{ old('harga_jual', 0) }}" class="form-control @error('harga_jual') is-invalid @enderror">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="profile_type" id="profile-type-unlimited" value="unlimited" @checked(old('profile_type', 'unlimited') === 'unlimited')>
                        <label class="form-check-label" for="profile-type-unlimited">Unlimited</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="profile_type" id="profile-type-limited" value="limited" @checked(old('profile_type') === 'limited')>
                ...
                <div id="limit-type-section" class="mb-3" style="{{ $profileType === 'limited' ? '' : 'display:none;' }}">
                    ...
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="limit_type" id="limit-type-time" value="time" @checked(old('limit_type', 'time') === 'time')>
                        <label class="form-check-label" for="limit-type-time">TimeBase</label>
                    </div>
                    <div class="form-check form-check-inline">
                        <input class="form-check-input" type="radio" name="limit_type" id="limit-type-quota" value="quota" @checked(old('limit_type') === 'quota')>
                ...
                <div id="time-limit-section" class="form-row" style="{{ $profileType === 'limited' && $limitType === 'time' ? '' : 'display:none;' }}">
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" min="1" name="time_limit_value" value="{{ old('time_limit_value', 60) }}" class="form-control @error('time_limit_value') is-invalid @enderror">
                ...
                <div id="quota-limit-section" class="form-row" style="{{ $profileType === 'limited' && $limitType === 'quota' ? '' : 'display:none;' }}">
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" min="1" step="0.01" name="quota_limit_value" value="{{ old('quota_limit_value', 1024) }}" class="form-control @error('quota_limit_value') is-invalid @enderror">
                ...
                <div id="masa-aktif-section" class="form-row" style="{{ $profileType === 'unlimited' ? '' : 'display:none;' }}">
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" min="1" name="masa_aktif_value" value="{{ old('masa_aktif_value', 30) }}" class="form-control @error('masa_aktif_value') is-invalid @enderror">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="number" min="1" name="shared_users" value="{{ old('shared_users', 1) }}" class="form-control @error('shared_users') is-invalid @enderror">
