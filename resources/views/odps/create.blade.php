...
<div class="card">
    <div class="card-header d-flex justify-content-between align-items-center">
        <h4 class="mb-0">Tambah Data ODP</h4>
    ...
    <form action="{{ route('odps.store') }}" method="POST">
        ...
        <div class="card-body">
            <div class="form-row">
                ...
                <div class="form-group col-md-4">
                    ...
                    <div class="input-group">
                        <input type="text" name="code" id="odp-code" value="{{ old('code') }}" class="form-control @error('code') is-invalid @enderror" required>
            ...
            <div class="form-row">
                <div class="form-group col-md-4">
                    <label>Area</label>
                    <input type="text" name="area" id="odp-area" value="{{ old('area') }}" class="form-control @error('area') is-invalid @enderror">
                    @error('area')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="form-group col-md-4">
                    <label>Kapasitas Port</label>
                    <input type="number" name="capacity_ports" value="{{ old('capacity_ports', 8) }}" min="0" class="form-control @error('capacity_ports') is-invalid @enderror">
            ...
            <div class="form-row">
                <div class="form-group col-md-5">
                    ...
                    <input type="text" name="latitude" id="odp-latitude" value="{{ old('latitude') }}" class="form-control @error('latitude') is-invalid @enderror" placeholder="-7.1234567">
                    @error('latitude')<div class="invalid-feedback">{{ $message }}</div>@enderror
                </div>
                <div class="form-group col-md-5">
                    <label>Longitude</label>
                    <input type="text" name="longitude" id="odp-longitude" value="{{ old('longitude') }}" class="form-control @error('longitude') is-invalid @enderror" placeholder="109.1234567">
