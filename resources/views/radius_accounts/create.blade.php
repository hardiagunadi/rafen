...
@section('content')
    <div class="card">
        <div class="card-header">Form Akun</div>
            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" name="ipv4_address" value="{{ old('ipv4_address') }}" class="form-control @error('ipv4_address') is-invalid @enderror" placeholder="Hanya untuk PPPoE">
                        @error('ipv4_address')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="form-group col-md-4">
                        <label>Rate Limit (mis. 10M/10M)</label>
                        <input type="text" name="rate_limit" value="{{ old('rate_limit') }}" class="form-control @error('rate_limit') is-invalid @enderror">
                ...
                <div class="form-row">
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" name="profile" value="{{ old('profile') }}" class="form-control @error('profile') is-invalid @enderror">
