...
<div class="card">
    <div class="card-header">
        <h4 class="mb-0">Ekspor Transaksi / Invoice ke CSV</h4>
    </div>
    <div class="card-body">
        ...
        <div class="alert alert-info mb-0">
            ...
            File berisi: nomor invoice, nama pelanggan, paket, nominal, status, tanggal jatuh tempo, tanggal bayar, dan metode pembayaran.
        </div>
    </div>
</div>
@endsection
