...
@section('content')
    <div class="card">
        <div class="card-header">
            <h4 class="mb-0">Tambah Profil Group</h4>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="ip_pool_name" value="{{ old('ip_pool_name') }}" class="form-control @error('ip_pool_name') is-invalid @enderror" placeholder="Pool Mikrotik">
