            ...
            <div class="card-body">
                ...
                <div class="form-row">
                    <div class="form-group col-md-6" id="dns-server-group">
                        ...
                        <input type="text" id="dns_servers" name="dns_servers" value="{{ old('dns_servers', $profileGroup->dns_servers ?? '8.8.8.8,8.8.4.4') }}" class="form-control @error('dns_servers') is-invalid @enderror" placeholder="8.8.8.8,8.8.4.4">
                        @error('dns_servers')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="form-group col-md-6">
                        <label>Parent Queue <small class="text-muted">(opsional)</small></label>
                        ...
                        <small class="text-muted" id="queue-fetch-status">Kosongkan untuk menggunakan parent queue dari Profil PPP.</small>
                    </div>
                </div>
            </div>
